...
var PORT = 3000;
var url = "http://localhost:".concat(PORT, "/api/v1");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post("".concat(url, "/users/login"), {
              email: email,
              password: password
            });
...
// Select DOM Elements
var loginForm = document.querySelector('#login-form'); // Dispatch Actions
