...
},{"../core-js/promise":"../../node_modules/@babel/runtime-corejs2/core-js/promise.js"}],"../../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
var PORT = 3000;
var url = "http://localhost:".concat(PORT, "/api/v1/users");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post("".concat(url, "/login"), {
              email: email,
              password: password
            });
...
},{"@babel/runtime-corejs2/regenerator":"../../node_modules/@babel/runtime-corejs2/regenerator/index.js","@babel/runtime-corejs2/helpers/asyncToGenerator":"../../node_modules/@babel/runtime-corejs2/helpers/asyncToGenerator.js","axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"authUI.js":[function(require,module,exports) {
"use strict";
...
var showPassword = function showPassword(el) {
...
var togglePassword = function togglePassword() {
  _index.elements.togglePassword.addEventListener('click', function (e) {
    var inputStatus = _index.elements.loginForm.password.dataset.status;

    if (inputStatus === 'shown') {
      return hidePassword(_index.elements.togglePassword);
    }

    return showPassword(_index.elements.togglePassword);
  });
};

exports.togglePassword = togglePassword;
},{"./index":"index.js"}],"index.js":[function(require,module,exports) {
"use strict";
